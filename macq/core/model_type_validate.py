...
from macq.core import LiftedAction, GroundedAction, LiftedFluent, GroundedFluent, ParameterBoundLiteral
...
class ModelTypeValidator:
    ...
    def validate_model_consistency(actions: Set, fluents: Set) -> ModelType:
        ...
        action_type = ModelTypeValidator.detect_action_type(actions)
        fluent_type = ModelTypeValidator.detect_fluent_type(fluents)
